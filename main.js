...
function ordertable() {
  ...
  var cell1 = row.insertCell(0);
  var cell2 = row.insertCell(1);
  cell1.setAttribute("class", "cell1 totalcell");
...
function dayitem() {
  ...
  if (day === 1) {
    ...
    document.getElementById("dayanchor").setAttribute('href', 'product.html#diamondfridge');
  }
  //tuesday
  if (day === 2) {
    ...
    document.getElementById("dayanchor").setAttribute('href', 'product.html#headphones');
  }
  //wednesday
  if (day === 3) {
    ...
    document.getElementById("dayanchor").setAttribute('href', 'product.html#fidgetspinner');
  }
  //thursday
  if (day === 4) {
    ...
    document.getElementById("dayanchor").setAttribute('href', 'product.html#laptopbag');
  }
  //friday
  if (day === 5) {
    ...
    document.getElementById("dayanchor").setAttribute('href', 'product.html#replicabuic');
  }
  //saturday
  if (day === 6) {
